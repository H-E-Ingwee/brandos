...
import { Target, ChevronRight, ChevronLeft, CheckCircle, Sparkles, AlertCircle } from 'lucide-react'
...
const questions = [
  {
    ...
    hint: 'Enter the official name you use for your business.',
    type: 'text',
    placeholder: 'e.g. Savanna Skincare',
  },
  {
    id: 'what_you_do',
    section: 'Your Business',
    question: 'What does your business do? Describe it in 1–2 sentences.',
    hint: 'Be specific. What do you sell or offer, and to whom?',
    type: 'textarea',
    placeholder: 'e.g. We make and sell natural skincare products for Kenyan women with sensitive skin...',
  },
  {
    id: 'sector',
    section: 'Your Business',
    question: 'What sector or industry are you in?',
    hint: 'Select the option that best describes your business.',
    type: 'select',
    options: ['E-Commerce / Retail', 'Healthcare / Wellness', 'Technology / Startup', 'Professional Services', 'NGO / Social Enterprise', 'Restaurant / Food & Beverage', 'Education', 'Real Estate', 'Agriculture / Agritech', 'Finance / Fintech', 'Other'],
  },
  {
    id: 'stage',
    section: 'Your Business',
    question: 'What stage is your business at?',
    hint: 'This helps us calibrate the right brand strategy for where you are now.',
    type: 'radio',
    options: ['Just launched (under 1 year)', 'Early stage (1–3 years)', 'Growing (3–7 years)', 'Established (7+ years)', 'Scaling / expanding into new markets'],
  },
  {
    id: 'ideal_customer',
    section: 'Your Audience',
    question: 'Who is your ideal customer? Describe them in detail.',
    hint: 'Include age, gender, location, income level, occupation, and what they care about most.',
    type: 'textarea',
    placeholder: 'e.g. Women aged 25–40, based in Nairobi, earning KES 50,000+/month, health-conscious, active on Instagram...',
  },
  {
    id: 'customer_problem',
    section: 'Your Audience',
    question: 'What is the biggest problem your ideal customer has that your business solves?',
    hint: 'Be specific. What frustration, challenge, or need does your product/service address?',
    type: 'textarea',
    placeholder: 'e.g. They struggle to find natural skincare products that work for African skin without harsh chemicals...',
  },
  {
    id: 'competitors',
    section: 'Your Market',
    question: 'Who are your top 3 competitors? (Name them)',
    hint: 'Include both direct competitors and alternative solutions your customers might use.',
    type: 'textarea',
    placeholder: 'e.g. 1. Skin Gourmet Kenya  2. Natures Gentle Touch  3. Imported brands like Shea Moisture...',
  },
  {
    id: 'differentiator',
    section: 'Your Market',
    question: 'What makes your business genuinely different from your competitors?',
    hint: 'Be honest. What do you do better, differently, or uniquely?',
    type: 'textarea',
    placeholder: 'e.g. We are the only brand that formulates specifically for Kenyan climate and skin types, using locally sourced ingredients...',
  },
  {
    id: 'brand_words_current',
    section: 'Your Brand',
    question: 'How would you describe your CURRENT brand in 3 words?',
    hint: 'Be honest — this is your current reality, not your aspiration.',
    type: 'text',
    placeholder: 'e.g. Inconsistent, local, affordable',
  },
  {
    id: 'brand_words_desired',
    section: 'Your Brand',
    question: 'How do you WANT your brand to be perceived? What 3 words describe your ideal brand?',
    hint: 'This is your brand aspiration — what you want customers to feel and think.',
    type: 'text',
    placeholder: 'e.g. Premium, trustworthy, authentically African',
  },
  {
    id: 'brand_personality',
    section: 'Your Brand',
    question: 'What is your brand\'s personality? Select all that apply.',
    hint: 'Choose the traits that best describe how your brand should feel to customers.',
    type: 'multiselect',
    options: ['Professional & authoritative', 'Warm & approachable', 'Bold & energetic', 'Innovative & forward-thinking', 'Trustworthy & reliable', 'Creative & expressive', 'Minimal & clean', 'Premium & exclusive', 'Playful & fun', 'Earthy & natural'],
  },
  {
    id: 'goal_12months',
    section: 'Your Goals',
    question: 'What is your single most important business goal for the next 12 months?',
    hint: 'Be specific. e.g. "Grow revenue from KES 500K to KES 2M" not just "grow the business".',
    type: 'textarea',
    placeholder: 'e.g. Grow monthly revenue from KES 150,000 to KES 500,000 by expanding to Mombasa and launching online sales...',
  },
  {
    id: 'digital_channels',
    section: 'Your Digital Presence',
    question: 'Which digital channels are you currently using?',
    hint: 'Select all that apply.',
    type: 'multiselect',
    options: ['Instagram', 'Facebook', 'TikTok', 'LinkedIn', 'Twitter / X', 'YouTube', 'WhatsApp Business', 'Website', 'Google Business Profile', 'None yet'],
  },
  {
    id: 'biggest_challenge',
    section: 'Your Digital Presence',
    question: 'What is your biggest brand or marketing challenge right now?',
    hint: 'Be honest. This is the most important question — your answer shapes everything we build for you.',
    type: 'textarea',
    placeholder: 'e.g. People don\'t know we exist. We have a great product but no one is finding us online...',
  },
]
...
export default function DiscoveryPage() {
  ...
  const toggleMultiselect = (option: string) => {
    ...
    if (current.includes(option)) {
      updateAnswer(current.filter(o => o !== option))
    } else {
      ...
      <div className="min-h-full flex items-center justify-center p-8">
        <div className="max-w-lg w-full text-center">
          ...
          <p className="text-white/60 mb-8 leading-relaxed">
            Excellent work. Your AI brand coach has analysed your answers and is ready to build your Brand Strategy. This is where the magic happens.
          </p>
          <div className="bg-[#1A2E3D] border border-white/8 rounded-2xl p-6 mb-8 text-left">
            ...
            <div className="space-y-3">
              {[
                { label: 'Business', value: (answers.business_name as string) || 'Your Business' },
                { label: 'Sector', value: (answers.sector as string) || 'Not specified' },
                { label: 'Stage', value: (answers.stage as string) || 'Not specified' },
                { label: 'Brand aspiration', value: (answers.brand_words_desired as string) || 'Not specified' },
              ].map(item => (
          ...
          >
            Build My Brand Strategy <Sparkles className="w-5 h-5" />
          </button>
        </div>
      </div>
    )
    ...
    return (
      <div className="min-h-full flex items-center justify-center p-8">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-display font-bold text-white mb-2">Analysing your brand...</h2>
          <p className="text-white/50">Your AI coach is processing your answers</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-full p-6 lg:p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-center text-white/20 text-xs mt-4">Your answers are saved automatically</p>
      </div>
    </div>
  )
}